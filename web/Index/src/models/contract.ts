...
const ContractModel: ContractModelType = {
  ...
  effects: {
    ...
    *setupDeploy({ payload }, { call, put, select }) {
      ...
      // if (chainType === 'hmy') {
      //   const structs = (yield harmony.blockchain.getShardingStructure()).result;
      //   harmony.shardingStructures(structs);
      // }
      const prv = from;
      ...
      const txnObj: any = {
        ...
        toShardID: currentShardID !== undefined ? currentShardID : 0,
      };
      if (amount) {
